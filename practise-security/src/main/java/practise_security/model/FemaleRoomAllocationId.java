...
@EqualsAndHashCode
public class FemaleRoomAllocationId implements Serializable{
		...
		public FemaleRoomAllocationId(String room_no, char bed_no, String wing) {
			super();
			this.room_no = room_no;
			this.bed_no = bed_no;
			this.wing = wing;
		}
		public FemaleRoomAllocationId() {
			super();
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			FemaleRoomAllocationId other = (FemaleRoomAllocationId) obj;
